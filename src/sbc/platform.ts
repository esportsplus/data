...
export { allocBuf, allocUnsafe, byteLen, copyBuf, FIELD_SIZES, fromUtf8, isNode, readBI64, readF64, readI16, readI32, readShortStr, readU16, readU32, readUtf8, readVarint, readZigzag, toUtf8, varintResult, writeBI64, writeF64, writeI16, writeI32, writeU16, writeU32, writeUtf8, writeVarint, writeZigzag };
// Internal: only consumed by codegen.ts and registry.ts — not part of the public sbc API
export { driver, textDecoder };
